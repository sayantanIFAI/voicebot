...
_BN_RATE = ("রেট", "দাম", "খরচ", "চার্জ", "মূল্য", "কত টাকা", "কত পড়বে",
              "কত লাগবে", "কত নেবে", "প্রাইস", "টাকা লাগে")
_BN_AVAIL = ("কবে", "কখন", "বসবেন", "বসেন", "চেম্বার", "আছেন", "থাকবেন",
               "পাওয়া যাবে", "ভিজিট", "সময়সূচি", "শিডিউল")
_BN_BOOK = ("বুক", "বুকিং", "অ্যাপয়েন্টমেন্ট", "অ্যাপয়েনমেন্ট", "সিরিয়াল",
              "নাম লেখা", "স্লট")
...
# shape.
_BN_PREP = ("প্রস্তুতি", "উপবাস", "উপোস", "খালি পেটে", "ফাস্টিং", "আগে কী করতে হবে",
...
_HI_RATE = ("रेट", "दाम", "कीमत", "प्राइस", "चार्ज", "फीस", "खर्चा", "कितने रुपये", "कितने पैसे", "कितने का",
            "कितना खर्च", "कितना पड़ेगा")
_HI_AVAIL = ("कब", "कितने बजे", "बैठते", "बैठती", "बैठेंगे", "चैंबर", "उपलब्ध", "मिलेंगे", "मिलते", "विज़िट",
             "विजिट", "शेड्यूल")
_HI_BOOK = ("बुक", "बुकिंग", "अपॉइंटमेंट", "अपॉइन्टमेंट", "अपोइंटमेंट", "सीरियल", "स्लॉट", "नाम लिखवा", "नंबर लगा")
...
_EN_RATE = ("price", "prices", "pricing", "cost", "costs", "rate", "rates", "charge", "charges", "fee", "fees",
            "how much")
_EN_AVAIL = ("when", "what time", "available", "availability", "timing", "timings", "sit", "sits", "sitting",
             "chamber", "schedule", "visit")
_EN_BOOK = ("book", "booking", "appointment", "appointments", "reserve", "reservation", "slot", "slots",
            "arrange")
_EN_PREP = ("preparation", "preparations", "prepare", "fasting", "fast", "empty stomach", "before the test",
            "eat before", "drink before", "what should i do before", "instructions")
_EN_GREETING = ("hello", "hi", "hey", "good morning", "good afternoon", "good evening", "namaste")
