...
@pytest.mark.parametrize("text,lang", [("শেষ করে দিন", "bn"), ("শেষ করুন", "bn"), ("না, আর কিছু না", "bn"), ("থাক", "bn"),
                                       ("खत्म कर दीजिए", "hi"), ("बस", "hi"), ("nothing else", "en"), ("no thanks", "en"),
                                       ("that's it", "en"), ("end it", "en")])
...
@pytest.mark.parametrize("text,lang", [("কল কেটে দিন", "bn"), ("ফোন রাখছি", "bn"), ("कॉल खत्म करो", "hi"), ("फोन रखता हूँ", "hi"),
                                       ("end the call", "en"), ("goodbye", "en"), ("that's all", "en"), ("bye", "en")])
...
@pytest.mark.parametrize("text,lang", [("বুকিং শেষ করে দিন", "bn"), ("আমি বুকিং শেষ করতে চাই", "bn"),
                                       ("finish the booking", "en"), ("maybe tomorrow", "en"), ("what is the price", "en"),
                                       ("", "en"), ("अपॉइंटमेंट बस कर दीजिए", "hi")])
...
@pytest.mark.parametrize("text", ["তুই বাল", "তুমি মাদারচোদ", "madarchod", "you are a bastard", "fuck you", "तू भोसड़ी का",
                                  "tum chutiya ho", "শুয়োরের বাচ্চা", "কুত্তার বাচ্চা"])
def test_swearing_is_recognised_in_all_three_languages_and_in_latin_spelling(text):
    assert abuse.is_abusive(text)


@pytest.mark.parametrize("text", ["আমাকে বলুন", "বালক ছেলের জন্য ডাক্তার", "বালি", "what is the price", "কবে বসছে",
                                  "ডক্টর পার্থ রায়", "সব ঠিক আছে", "sale price", "साला", "hello"])
